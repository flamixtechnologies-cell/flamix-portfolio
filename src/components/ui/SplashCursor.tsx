...
// Brand palette (normalized 0–1 RGB), aligned with Tailwind config:
// primary 500: #7A1CAC, secondary 400: #AD49E1, accent: #EBD3F8
const BRAND_COLORS = [
  { r: 122 / 255, g: 28 / 255, b: 172 / 255 }, // primary 500
  { r: 173 / 255, g: 73 / 255, b: 225 / 255 }, // secondary 400
  { r: 235 / 255, g: 211 / 255, b: 248 / 255 }, // accent
];

// Tertiary / deep background tone: #2E073F
const BRAND_BG = { r: 46 / 255, g: 7 / 255, b: 63 / 255 };

function SplashCursor({
  SIM_RESOLUTION = 128,
  DYE_RESOLUTION = 1440,
  CAPTURE_RESOLUTION = 512,
  // higher dissipation → fluid fades faster → visually less dense
  DENSITY_DISSIPATION = 4.5,
  VELOCITY_DISSIPATION = 2,
  PRESSURE = 0.1,
  PRESSURE_ITERATIONS = 20,
  CURL = 3,
  // smaller ghost cursor than the original
  SPLAT_RADIUS = 0.04,
  SPLAT_FORCE = 2000,
  SHADING = true,
  ...
  useEffect(() => {
    ...
    // TypeScript now knows canvas is non-null after this check
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      let isWebGL2Context = (gl as WebGL2RenderingContext).renderbufferStorageMultisample !== undefined;
      ...
      const halfFloatTexType = isWebGL2Context
    ...
    if (!glContext || !ext) return;

    // TypeScript now knows gl is non-null after this check
    const gl = glContext as NonNullable<typeof glContext>;
    ...
    class Material {
      ...
      setKeywords(keywords: string[]) {
        ...
        if (program == null) {
          let fragmentShader = compileShader((gl as WebGL2RenderingContext).FRAGMENT_SHADER, this.fragmentShaderSource, keywords);
    ...
    function generateColor() {
      // Pick from brand palette and keep it fairly soft for a light ghost effect
